...
I build platforms and run the businesses they power. A decade turning operational bottlenecks into technology — from Python automation at a 120-agent real estate firm to a 950K-line AdTech platform that held 85% gross margins.
...
**Nuvestan** — Personal finance for first-generation wealth builders. Next.js 16, Supabase, Plaid, Stripe. 226 tests.

**CourtVision** — Full-stack NBA analytics. 441+ pages, 90+ components, 6 data sources.

## Portfolio

**[stephenumunna.com](https://stephenumunna.com)** — Interactive case studies, playable demos, and deep dives.

## Contact

scumunna@gmail.com · (323) 917-1875 · [LinkedIn](https://linkedin.com/in/stephenumunna)
